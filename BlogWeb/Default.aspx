...
<body id="page-top">
        ...
        <ItemTemplate>
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
                    ...
                    <%--<span class="d-none d-lg-block">--%>
                        <img class="img-fluid img-profile rounded-circle mx-auto mb-2" style="max-width:14rem;" src='<%# Eval("FOTOGRAF") %>'  alt="">
                    <%--</span>--%>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger" href="#">Hakkımda</a>
                        </li>
                        <li class="nav-item">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
        <div class="my-auto">
            ...
            <div class="subheading mb-3">Programlama Dilleri &amp; Araçları</div>
                ...
                <asp:Repeater ID="Repeater5" runat="server">
                    <ItemTemplate>
                        <li>
                            ...
                            <asp:Label ID="Label17" runat="server" Text='<%# Eval("YETENEK") %>'></asp:Label>
